...
<center>
  <button class="w3-bar-item w3-button" style="border:1px solid #CCC; border-radius: 8px; solid #CCC; background-color:lightgreen;" onclick="openCity('News')">News</button>
  &nbsp;&nbsp;<b> </b>&nbsp;&nbsp;
  <button class="w3-bar-item w3-button" style="border:1px solid #CCC; border-radius: 8px; solid #CCC; background-color:yellow;" onclick="openCity('For Students')">For Students</button>
  &nbsp;&nbsp;<b> </b>&nbsp;&nbsp;
  <button class="w3-bar-item w3-button" style="border:1px solid #CCC;  border-radius: 8px; background-color:lightblue; " onclick="openCity('For Industry')">For Industry</button>
  &nbsp;&nbsp;<b> </b>&nbsp;&nbsp;
  <button class="w3-bar-item w3-button" style="border:1px solid #CCC;  border-radius: 8px; background-color:orange;" onclick="openCity('For Researchers')">For Researachers</button>
</center>
</div>
...
<h3>News</h3>
          <ul>
            <li id="">    <b>May'23</b>: Incited to FSE'24 to program committee
...
When writing to a CS prof in the USA, here is some advice on how to attract their attention.</p>
